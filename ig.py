...
print("""\033[32;1m
   ...
   YMMMb.       dMM8
    YMMMMb     dMMM'
     ...
     dMM  MMMMMMM  -=[BUATAN: WahyuHack]=-
     8MMMMMMMMMMI  -=[Team : Hacker Indonesia eXploit]=-
      YMMMMMMMMM   -=[INSTAGRAM: Guswahyu21]=-
        MMMMMMP
       MxM .mmm
_________________[WAHYU HACK 2019]____________________
MOHON GUNAKAN SCRIP INI UNTUK KEBAIKAN BUKAN UNTUK KEJAHATAN
SEBAB KEJAHATAN LEBIH BURUK DAN MENYEBABKAN ANDA TERSESAT
DALAM MASALAH APAPUN !
_________________[Copyright 2019]_____________________
""")
...
| $$$/ \  $$| $$  | $| $$  | $$   | $$   | $$  | $| $$  | $| $$  | $| $$    $| $$\  $$ 
| $$/   \  $| $$  | $| $$  | $$   | $$   |  $$$$$$| $$  | $| $$  | $|  $$$$$$| $$ \  $$
|__/     \__|__/  |__|__/  |__/   |__/    \______/|__/  |__|__/  |__/\______/|__/  \__/
...
try:
	delayLoop = int(Input('\033[36;1m[*] Please add delay between the bruteforce action (in seconds): ')) 
except Exception as e:
